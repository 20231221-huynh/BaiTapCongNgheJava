...
public class BaiLab4_Bai1 extends javax.swing.JFrame {

    /**
     * Creates new form BaiLab4_Bai1
     */
    public BaiLab4_Bai1() {
        initComponents();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtGiay, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnBatDau)
    ...
    private void btnBatDauActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBatDauActionPerformed
            try{
                int soGiay = Integer.parseInt(txtGiay.getText().trim());
                if(soGiay <= 0){
                    JOptionPane.showMessageDialog(this, "Vui long nhap so giay lon hon 0!");
                    return;
                }
                ...
                SwingWorker<Void, Integer> sw = new SwingWorker<Void, Integer>(){
                    ...
                    protected void process(java.util.List<Integer> list){
                        int time = list.get(list.size() - 1);
                        lblTime.setText("Thoi gian con lai: " + " giay");
                    }
                    
                    @Override
                    protected void done(){
                        btnBatDau.setEnabled(true);
                        JOptionPane.showMessageDialog(BaiLab4_Bai1.this, "Hết giờ!");
                    }
                };
                sw.execute();
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Vui long nhap so giay hop le!");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaiLab4_Bai1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaiLab4_Bai1().setVisible(true);
            }
        });
    }
